...
namespace Random
{
	...
	// This is the C++11/14 way to define a static global variable in a header file
	// It's guaranteed to be initialized once.
	...
	{
		return std::uniform_int_distribution<int>{min, max}(get_mt());
	}
